...
import com.servalabs.chat.registration.data.QuickstartCredentials
...
object QuickstartInitializer {
  ...
  private val diskCredentialFileName: String
    get() = if (com.servalabs.chat.util.Environment.IS_STAGING) "staging_credentials.json" else "prod_credentials.json"
